...
public class LoginController {
    ...
    public Map<String,Object>  login(@RequestBody Map<String,String> paramMap){
        ...
        List<String> sessionList = jedisClient.lrang(sso_id+"_"+Id,0,-1);
        ...
        if(StringUtils.isBlank(hashCode)){
            ...
            while (jedisClient.lrang(sso_id+"_"+Id,0,-1).size() > MaxSession){
                ...
                HaiSession kickSession = haiSessionDao.doReadSession(kickId);
                if (kickSession != null) {
                    // 设置会话的kickout属性表示踢出了
